...
public class Soal implements Parcelable {
    ...
    private List<Sej11Soal> sej11_soal;
    ...
    public List<Sej11Soal> getSej11_soal() {
        return sej11_soal;
    }

    public void setSej11_soal(List<Sej11Soal> sej11_soal) {
        this.sej11_soal = sej11_soal;
    }
    ...
    public static class Sej11Soal {
        ...
        public static Sej11Soal objectFromData(String str) {

            return new Gson().fromJson(str, Sej11Soal.class);
        }
